...
<link rel="icon" href="../img/clown1.png" type="image/png">
    <link rel="stylesheet" href="../收货.css">
    <link rel="stylesheet" href="../user.css">
    <script>
    var addressList = []; // 存储地址列表

    // 更新地址列表的显示
    function updateAddressList() {
        var cardsList = document.querySelector('.cards_list');
        cardsList.innerHTML = ''; // 清空原有内容
        ...
        addressList.forEach(function(address) {
            ...
            card.innerHTML = `
                ...
                <p>联系电话：${address.mobilePhone}</p>
                <p>默认地址：${address.isDefault ? '是' : '否'}</p>
            `;
    ...
    <div class="kuang">
       <div class="sidebar">
		...
		<!-- 账号概览 -->
			...
			<div data-v-7cc69776="" class="my_index_right">
  <div data-v-805ef47a="" data-v-7cc69776="" class="over_view">
    <div data-v-805ef47a="" class="view_herder">
      <span data-v-805ef47a="" class="user_name">您好 0 , 欢迎来到周大福</span>
      <div data-v-805ef47a="" class="herder_rirht">
        <a data-v-805ef47a="" class="el-link el-link--info is-underline" style="margin-right: 20px;">
          <!----><span class="el-link--inner">会员中心</span><!---->
        </a>
        <a data-v-805ef47a="" class="el-link el-link--info is-underline">
          <!----><span class="el-link--inner">退出账户</span><!---->
        </a>
      </div>
    </div>
    <div data-v-805ef47a="" class="membership">
      <span data-v-805ef47a="" class="term_validity">有效期: 长期有效</span>
      <img data-v-805ef47a="" src="https://cdn.ctfmall.com/path/pc-membership-level-icon@3x.png" alt="" class="cart_bottom_advertisement_img">
      <!----><!----><!----><!---->
    </div>
    <div data-v-805ef47a="" class="view_center mt20">
      <div data-v-805ef47a="" class="el-row" style="margin-left: -10px; margin-right: -10px;">
        <div data-v-805ef47a="" class="el-col el-col-12" style="padding-left: 10px; padding-right: 10px;">
          <div data-v-805ef47a="" class="grid-content">
            <span data-v-805ef47a="" class="grid_name">个人资料</span>
            <div data-v-805ef47a="" class="grid_center">
              <span data-v-805ef47a="" class="mr20">0</span>
              <div data-v-805ef47a="" class="certer_iphone">181****1528</div>
            </div>
            <div data-v-805ef47a="" class="btn">
              <button data-v-805ef47a="" type="button" class="el-button el-button--warning is-plain">
                <!----><!----><span>查看账户信息</span>
              </button>
            </div>
          </div>
        ...
        <div data-v-805ef47a="" class="el-col el-col-12" style="padding-left: 10px; padding-right: 10px;">
          <div data-v-805ef47a="" class="grid-content">
            <span data-v-805ef47a="" class="grid_name">我的订单</span>
            <div data-v-805ef47a="" class="haveNone">暂无任何订单记录，快去选购吧～</div>
            <div data-v-805ef47a="" class="btn_haveNone">
              <button data-v-805ef47a="" type="button" class="el-button el-button--warning is-plain">
                <!----><!----><span>去选购</span>
              </button>
            </div>
      ...
      <div data-v-805ef47a="" class="mt20 el-row" style="margin-left: -10px; margin-right: -10px;">
        <div data-v-805ef47a="" class="el-col el-col-12" style="padding-left: 10px; padding-right: 10px;">
          <div data-v-805ef47a="" class="grid-content">
            <span data-v-805ef47a="" class="grid_name">购物袋</span>
            <div data-v-805ef47a="" class="haveNone">您的购物袋是空的～</div>
            <div data-v-805ef47a="" class="btn_haveNone" style="margin-top: 4px;">
              <button data-v-805ef47a="" type="button" class="el-button el-button--warning is-plain">
                <!----><!----><span>去选购</span>
              </button>
            </div>
        ...
        <div data-v-805ef47a="" class="el-col el-col-12" style="padding-left: 10px; padding-right: 10px;">
          <div data-v-805ef47a="" class="grid-content">
            <span data-v-805ef47a="" class="grid_name">收货地址</span>
            <div data-v-805ef47a="" class="haveNone">您尚未保存收货地址～</div>
            <div data-v-805ef47a="" class="btn_haveNone">
              <button data-v-805ef47a="" type="button" class="el-button el-button--warning is-plain">
                <!----><!----><span>添加新地址</span>
              </button>
    ...
    <div data-v-d5c82bbe="" data-v-805ef47a="" class="el-dialog__wrapper" style="display: none;">
      <div role="dialog" aria-modal="true" aria-label="周大福会员中心" class="el-dialog" style="margin-top: 15vh; width: 500px;">
        <div class="el-dialog__header">
          <span class="el-dialog__title">周大福会员中心</span>
...
<div id="address" class="content-section">
    <div class="header_box">
        <span class="box_name">我的地址</span>
        <a id="addAddressBtn" class="el-link el-link--info is-underline" style="margin-right: 20px;">
            <span class="el-link--inner">添加新地址</span>
        </a>
    </div>
    ...
    <!-- 弹窗内容 -->
<div id="addressDialog" role="dialog" aria-modal="true" aria-label="新增收货地址" class="el-dialog" style="margin-top: 15vh; width: 830px;">
    <div class="el-dialog__header">
        <span class="el-dialog__title">新增收货地址</span>
        <button type="button" aria-label="关闭" class="el-dialog__headerbtn">
            <i class="el-dialog__close el-icon el-icon-close"></i>
        </button>
    </div>
    <div class="el-dialog__body">
        <p data-v-d5c82bbe=""></p>
        <form data-v-7b468b07="" class="el-form demo-ruleForm">
            <div data-v-7b468b07="" class="el-row" style="margin-left: -12px; margin-right: -12px;">
                <!-- 提取省市区选择部分 -->
                <div data-v-7b468b07="" class="el-col el-col-8" style="padding-left: 12px; padding-right: 12px;">
                    <div data-v-7b468b07="" class="el-form-item is-required">
                        <label for="ProvinceCode" class="el-form-item__label">省</label>
                        <div class="el-form-item__content">
                            <div data-v-7b468b07="" class="el-select">
                                <select class="el-input__inner" id="provinceSelect" onchange="updateCity()">
                ...
                <div data-v-7b468b07="" class="el-col el-col-8" style="padding-left: 12px; padding-right: 12px;">
                    <div data-v-7b468b07="" class="el-form-item is-required">
                        <label for="CityCode" class="el-form-item__label">市</label>
                        <div class="el-form-item__content">
                            <div data-v-7b468b07="" class="el-select">
                                <select class="el-input__inner" id="citySelect" onchange="updateArea()">
                ...
                <div data-v-7b468b07="" class="el-col el-col-8" style="padding-left: 12px; padding-right: 12px;">
                    <div data-v-7b468b07="" class="el-form-item is-required">
                        <label for="DistrictCode" class="el-form-item__label">区</label>
                        <div class="el-form-item__content">
                            <div data-v-7b468b07="" class="el-select">
                                <select class="el-input__inner" id="areaSelect">
            ...
            <!-- 省市区选择后面的内容 -->
            <div data-v-7b468b07="" class="el-form-item is-required">
                <label for="Street" class="el-form-item__label">详细地址</label>
                <div class="el-form-item__content">
                    <div data-v-7b468b07="" class="el-input">
                        <input type="text" autocomplete="off" placeholder="建议您详细填写收货地址，例如：街道，楼牌号等" class="el-input__inner">
                    </div>
                </div>
            </div>
            <div data-v-7b468b07="" class="el-row" style="margin-left: -12px; margin-right: -12px;">
                <div data-v-7b468b07="" class="el-col el-col-8" style="padding-left: 12px; padding-right: 12px;">
                    <div data-v-7b468b07="" class="el-form-item">
                        <label for="postalCode" class="el-form-item__label">邮政编码</label>
                        <div class="el-form-item__content">
                            <div data-v-7b468b07="" class="el-input">
                                <input type="text" autocomplete="off" placeholder="请输入邮政编码" class="el-input__inner">
                            </div>
                        </div>
                    </div>
                </div>
                <div data-v-7b468b07="" class="el-col el-col-8" style="padding-left: 12px; padding-right: 12px;">
                    <div data-v-7b468b07="" class="el-form-item is-required">
                        <label for="ReceiverName" class="el-form-item__label">收货人</label>
                        <div class="el-form-item__content">
                            <div data-v-7b468b07="" class="el-input">
                                <input type="text" autocomplete="off" placeholder="请输入收货人姓名" class="el-input__inner">
                            </div>
                        </div>
                    </div>
                </div>
                <div data-v-7b468b07="" class="el-col el-col-8" style="padding-left: 12px; padding-right: 12px;">
                    <div data-v-7b468b07="" class="el-form-item">
                        <label for="MobilePhone" class="el-form-item__label">联系电话</label>
                        <div class="el-form-item__content">
                            <div data-v-7b468b07="" class="el-input">
                                <input type="text" autocomplete="off" placeholder="请输入您的手机号码" class="el-input__inner">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div data-v-7b468b07="" class="el-form-item">
                <div class="el-form-item__content">
                    <label data-v-7b468b07="" class="el-checkbox">
                        <span class="el-checkbox__input">
                            <span class="el-checkbox__inner"></span>
                            <input type="checkbox" aria-hidden="false" true-value="1" false-value="0" class="el-checkbox__original">
                        </span>
                        <span class="el-checkbox__label">设为默认收货地址<!----></span>
                    </label>
                </div>
            </div>
        </form>
    ...
    <div class="el-dialog__footer">
        <span data-v-d5c82bbe="" class="dialog-footer">
            <!---->
           <button data-v-d5c82bbe="" type="button" class="el-button el-button--warning" style="width: 200px;"><!----><!---->
           <span> 保存 </span></button>
    ...
    // 点击关闭按钮隐藏弹窗
    document.querySelector('.el-dialog__footer').addEventListener('click', function() {
        document.getElementById('addressDialog').style.display = 'none';
    });
	...
	var data = [
	    ...
	    function updateCity() {
	        ...
	        if (provinceIndex !== "") {
	            var cities = data[provinceIndex].city;
	    ...
	    function updateArea() {
	        ...
	        if (provinceIndex !== "" && cityIndex !== "") {
	            var areas = data[provinceIndex].city[cityIndex].area;
 ...
 function saveAddress() {
     // 获取表单中的值
     const receiverName = document.querySelector('input[placeholder="请输入收货人姓名"]').value;
     const mobilePhone = document.querySelector('input[placeholder="请输入您的手机号码"]').value;
     const province = document.getElementById('provinceSelect').querySelector('option:checked').innerText;
     const city = document.getElementById('citySelect').querySelector('option:checked').innerText;
     const district = document.getElementById('areaSelect').querySelector('option:checked').innerText;
     const street = document.querySelector('input[placeholder="建议您详细填写收货地址，例如：街道，楼牌号等"]').value;
 
     // 创建新的地址条目
     const newAddressElement = document.createElement('div');
     newAddressElement.classList.add('address');
     newAddressElement.innerHTML = `
         <p>收货人：${receiverName}</p>
         <p>联系电话：${mobilePhone}</p>
         <p>地址：${province} ${city} ${district} ${street}</p>
     `;
 
     // 将新地址条目添加到地址列表
     document.querySelector('.cards_list').appendChild(newAddressElement);
 }
